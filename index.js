...
`.trim();
  ...
  async function uploadToPortal(data) {
    ...
    if (data.twitter)
      await page.type('input[name="twitter_link"]', data.twitter);
    if (data.facebook)
      await page.type('input[name="face_link"]', data.facebook);
    if (data.instagram)
      await page.type('input[name="insta_link"]', data.instagram);
    if (data.youtube)
      await page.type('input[name="youtube_link"]', data.youtube);
